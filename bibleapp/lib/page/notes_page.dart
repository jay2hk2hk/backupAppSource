...
class _NotesPageState extends State<NotesPage>
{
  ...
  static DateTime _selectedDay = DateTime.parse(dateFormat.format(DateTime.now()));
  ...
  void setInitEventInCal(DateTime firstDayDateTime, DateTime lastDayDateTime) async
  {
  ...
  Future<List<dynamic>> getMonthEvent(DateTime firstDayDateTime, DateTime lastDayDateTime/*, DateTime dateSelect*/) async
  {
    Map<DateTime, List> tempEvents = {};
    List<BibleNotes> tempList = await dbHelper.getBibleNotesByMonth(firstDayDateTime, lastDayDateTime);
    events = {};
  ...
  void _onCalendarCreated(DateTime first, DateTime last, CalendarFormat format)async {
    ...
    List<Widget> tempReturnList = selectedEvents
          .map((event) => Container(
                ...
                child: RaisedButton(
                              ...
                              child: Text(/*event[0].toString() + ' ' +*/ event[1].toString()
                ...
                child: RaisedButton(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(" "+FlutterI18n.translate(context, "addNote")
                                  ,style:new TextStyle(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true)
                                  ,color: buttonTextColor),),
                                    ],
                              ),
    ...
    tempList.add(
      TableCalendar(
                  ...
                  calendarStyle: CalendarStyle(
                    weekdayStyle: TextStyle().copyWith(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true)),
                    weekendStyle: TextStyle().copyWith(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true)),
                    selectedStyle: TextStyle().copyWith(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true)),
                  ...
                  headerStyle: HeaderStyle(
                    ...
                    titleTextStyle: TextStyle().copyWith(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true)),
                    formatButtonTextStyle: TextStyle().copyWith(color: buttonTextColor, fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true)),
                  ...
                  daysOfWeekStyle: DaysOfWeekStyle(
                    weekdayStyle: TextStyle().copyWith(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true)),
                    weekendStyle: TextStyle().copyWith(color:weekEndTextColor,fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true)),
                  ),
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SingleChildScrollView(    // new line
          ...
          children: <Widget>[
            TextFormField(
              style:TextStyle(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true),),
  ...
  showDialog<void>(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        title: Text(FlutterI18n.translate(context, "confirmDelete"),style:new TextStyle(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true))),
        content: Text(text),
        actions: <Widget>[
          FlatButton(
            child: Text(FlutterI18n.translate(context, "cancelButton"),style:new TextStyle(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true))),
            onPressed: () {
              Navigator.of(context).pop();
            },
          ),
          FlatButton(
            child: Text(FlutterI18n.translate(context, "okButton"),style:new TextStyle(fontSize: ScreenUtil().setSp(fontOfContent, allowFontScalingSelf: true))),
            onPressed: () async{
