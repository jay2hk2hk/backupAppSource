...
class _SearchPageState extends State<SearchPage> {
  ...
  static ItemScrollController _scrollController =
  ...
  Widget getSearch(BuildContext context) {
    ...
    for (int i = 0; i < bibleTitleTotalNum.length; i++) {
      ...
      for (int j = 0; j < bibleTitleTotalNum[i]; j++) {
        j1 = j + 1;
        List<String> tempList = unescape
            .convert(FlutterI18n.translate(context, "bible.$i1.$j1.content"))
            .split("=.=");
      ...
      child: Scaffold(
        appBar: AppBar(
          title: TextFormField(
            style: TextStyle(
              fontSize: ScreenUtil()
                  .setSp(fontOfContent - 10, allowFontScalingSelf: true),
            ),
                ...
                new Column(
                  children: <Widget>[
                    ...
                    new Container(
                      ...
                      child: new Wrap(
                        spacing: ScreenUtil().setSp(20.0,
                            allowFontScalingSelf:
                                true), // gap between adjacent chips
                        runSpacing: ScreenUtil().setSp(20.0,
                            allowFontScalingSelf: true), // gap between lines
  ...
  Widget getSearchResult(BuildContext context) {
    return /*MaterialApp(
      ...
      appBar: AppBar(
        ...
        title: displayListNum >= 0
            ? Text(
                FlutterI18n.translate(
                    context, "searchButtonList.$displayListNum"),
                style: new TextStyle(
                    fontSize: ScreenUtil()
                        ...
                        RaisedButton(
                          ...
                          onPressed: () {
                            if (prefs != null) {
                              prefs.setString(
                                  sharePrefTitleId,
                                  saveAllBibleSentence[displayListNum][index]
                                      .split(':')[0]);
  ...
  Widget build(BuildContext context) {
    ...
    return /*MaterialApp(
      ...
      home: */
        page == 0 ? getSearch(context) : getSearchResult(context);
    //);
  }
  ...
  Future<List<String>> loadQueryToList(BuildContext context) async {
    ...
    if (displayListNum < 0)
      ...
      tempList = saveAllBibleSentence[displayListNum];
